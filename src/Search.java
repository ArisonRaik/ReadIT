...
public class Search extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(415, 46, 144, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Titulo", "Autor", "Gênero", "Ano", "Pgs"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 560, 203));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(86, 47, 311, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Arison Raik\\Pictures\\39488852-abstract-square-background-vector-illustration.jpg")); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -180, 660, 550));
    ...
    //Search Button
        try{
            if( jTextField1.getText().equals(""))
                JOptionPane.showMessageDialog(null, "Insira o item!", "Oops Wait...!", JOptionPane.ERROR_MESSAGE);
            else{
               ...
               String search="", output="", target="";
                ...
                if( !found)
                    JOptionPane.showMessageDialog(null, "Publicação não encontrada!", "Ooops!", JOptionPane.ERROR_MESSAGE);
